...
/* --- 3. Contribution --------------------------------------------------- */
{
  ...
  fields: [
    ...
    { k: 'speaker_bio', t: 'textarea', wide: true, showIf: (d) => isYes(d.wants_to_present), reqIf: (d) => isYes(d.wants_to_present), max: 800, count: true, l: { en: 'Short biography', ar: 'سيرة ذاتية مختصرة' }, hint: { en: 'Published on the event page if you consent to publication.', ar: 'تُنشر في صفحة الحدث إذا وافقت على النشر.' } },
